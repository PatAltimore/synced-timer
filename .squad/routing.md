...
|-----------|----------|----------|
| Architecture & decisions | Keaton | System design, URLs, timer data model |
| Frontend & UX | McManus | Timer UI, mobile layout, QR display |
| Backend & APIs | Fenster | Timer endpoints, URL/query handling |
